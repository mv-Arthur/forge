...
/** Horizontal object strip — chrome patterned on ProjectCarousel, BuiltObjectCard slides. */
export function ObjectCarousel({ objects }: Props) {
    ...
    const showControls = objects.length > 1;
