...
/**
 * Сводка под hero: факты | цена+CTA.
 * Материал — только в блоке «Из чего построить», без дубля.
 */
            ...
            <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:gap-10">
                    ...
                    <div className="flex flex-wrap items-center gap-1.5">
                        ...
                        {project.builtCount > 0 ? (
                            <span className="badge bg-success/10 text-success">
                                построен {project.builtCount}{" "}
                                {timesWord(project.builtCount)}
                            </span>
                        ) : project.buildingCount > 0 ? (
                            <span className="badge badge-progress">
                                {project.buildingCount === 1
                                    ? "сейчас строится"
                                    : `строится ${project.buildingCount}`}
                            </span>
                        ) : null}
                        {project.hasTerrace ? (
                ...
                <div className="flex flex-col justify-between gap-4 border-t border-ink-150 pt-5 lg:min-w-[280px] lg:border-l lg:border-t-0 lg:pl-10 lg:pt-0">
                    <div>
                        ...
                        <div className="mt-1 font-display text-[28px] font-extrabold tabular-nums leading-none text-ink-950 md:text-[32px]">
                            {formatPrice(price)}
                        </div>
                    ...
                    <div className="space-y-2.5">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <a
                                ...
                                className="text-[13px] font-semibold text-ink-700 hover:text-ink-950"
                            >
                                {settings.phone}
                            </a>
                        </div>
